...
public class League {
    ...
    public Game[] createGames(Team[] theTeams) {
        /* Declare and initialize daysBetweenGames variable */
        ...
        for (Team homeTeam: theTeams){
            for (Team awayTeam: theTeams){
               if (homeTeam != awayTeam) {
                   /* Increment daysBetweenGames */
                   daysBetweenGames +=7;
                   /* Pass LocalDateTime into constructor and schedule games */
    ...
    /* getLeagueAnnouncement() method calculating time of league */
